...
struct ContentView: View {
    ...
    @State private var editingEntry: DreamEntry?
...
struct EntryRow: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            Text("Tags: \(entry.tags)  ·  Mood: \(entry.mood)")
                .font(.caption)
...
struct EntryFormView: View {
    ...
    init(mode: FormMode) {
        ...
        if case .edit(let entry) = mode {
            ...
            _f1 = State(initialValue: entry.tags)
            _f2 = State(initialValue: entry.mood)
            _f3 = State(initialValue: entry.notes)
        }
    }
        ...
        NavigationStack {
            Form {
                Section("Details") {
                    ...
                    TextField("Tags", text: $f1)
                        .accessibilityIdentifier("f1Field")
                    TextField("Mood", text: $f2)
                        .accessibilityIdentifier("f2Field")
                    TextField("Notes", text: $f3)
            ...
            .navigationTitle(mode == .add ? "Add Dream" : "Edit Dream")
            .toolbar {
